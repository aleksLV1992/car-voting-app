 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder|Vote whereCarId(int $car_id)
 * @method static \Illuminate\Database\Eloquent\Builder|Vote whereVoterId(string $voter_id)
 * @method static \Illuminate\Database\Eloquent\Builder|Vote uniqueVote(int $car_id, string $voter_id)
 */
